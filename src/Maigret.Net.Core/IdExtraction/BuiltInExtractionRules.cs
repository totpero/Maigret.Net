...
public static class BuiltInExtractionRules
{
    ...
    public static IReadOnlyList<ExtractionRule> All { get; } = new[]
    {
        // GitHub HTML profile page
        new ExtractionRule("GitHub", new[]
        {
        ...
        new ExtractionRule("HackerNews", new[]
        {
        ...
        new ExtractionRule("Instagram", new[]
        {
        ...
        new ExtractionRule("Twitter", new[]
        {
